<template>
  <div>
    <div class="mb-16">
      <h1 class="text-3xl">Birth chart</h1>
      <p class="text-xl">Enter the data bellow to find out</p>
    </div>

    <form @submit.prevent="onClickSummit">
      <div class="mt-4 flex flex-col items-center">
        <label for="birthdate">Birthdate:</label>
        <input class="mt-2 p-4 bg-zinc-800 w-40" type="date" id="birthdate" v-model="birthdate" required>
      </div>
      <div class="mt-4 flex flex-col items-center">
        <label for="birthtime">Time of Birth:</label>
        <input class="mt-2 p-4 bg-zinc-800 w-40" type="time" id="birthtime" v-model="birthtime" required>
      </div>
      <div class="mt-4 flex flex-col items-center">
